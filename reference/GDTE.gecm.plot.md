...
- inferences.x:
  ...
  independent variable in levels or in differences? The default is
  `levels`
...
variables, as well as the order of the differencing. Internally, the
GECM to ADL equivalences are used to calculate the GDTEs from the GECM
